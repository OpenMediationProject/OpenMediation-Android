...
public class PermissionHelper {
    ...
    private final static int REQUEST_OPEN_APPLICATION_SETTINGS_CODE = 1234;

    private final static int REQUEST_OPEN_LOCATIO_SETTINGS_CODE = 103;
    private final static int REQUEST_OPEN_ACCESS_COARSE_LOCATION = 104;
    /**
    ...
    private PermissionModel[] mPermissionModels = new PermissionModel[]{
            ...
            new PermissionModel(
                    ...
                    "我们需要定位操作",
                    REQUEST_OPEN_LOCATIO_SETTINGS_CODE
            ), new PermissionModel(
            "定位",
            Manifest.permission.ACCESS_COARSE_LOCATION,
            "我们需要定位操作",
            REQUEST_OPEN_ACCESS_COARSE_LOCATION
    )
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
        switch (requestCode) {
            ...
            case REQUEST_OPEN_LOCATIO_SETTINGS_CODE:
            case REQUEST_OPEN_ACCESS_COARSE_LOCATION:
