...
public abstract class FastPluginManager extends PluginManagerThatUseDynamicLoader {
    ...
    public InstalledPlugin installPlugin(String zip, String hash, boolean odex) throws IOException, JSONException, InterruptedException,
            ExecutionException {
    ...
    public void startPluginActivity(Context context, Intent pluginIntent) throws RemoteException {
        Intent intent = convertActivityIntent(pluginIntent);
    ...
    public Intent convertActivityIntent(Intent pluginIntent) throws RemoteException {

        return mPluginLoader.convertActivityIntent(pluginIntent);
    }

    protected void loadPluginLoaderAndRuntime(String uuid) throws RemoteException, TimeoutException, FailedException {
